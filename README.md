...
- `secure-auth-actix`: compile-tested Actix Web adapter for the same OPAQUE HTTP contract; it validates CSRF from request parts before bounded payload buffering and preserves the generic error/security-header boundary.
