...
- [x] Expose a secret-free passkey presentation controller so RN/Web/custom host UIs can render lifecycle state without receiving credential results through UI state.
