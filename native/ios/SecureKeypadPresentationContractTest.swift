...
struct SecureKeypadPresentationContractTest {
    static func main() {
        ...
        precondition(secureKeypadShouldClearSessionForScreenCapture(screenIsCaptured: true, sessionIsLive: true))
        precondition(!secureKeypadShouldClearSessionForScreenCapture(screenIsCaptured: true, sessionIsLive: false))
        precondition(!secureKeypadShouldClearSessionForScreenCapture(screenIsCaptured: false, sessionIsLive: true))
        ...
        precondition(!secureKeypadShouldReconfigureSession(hasWindow: true, sessionIsNil: true, protected: true))
