...
@interface RCT_EXTERN_MODULE(SecureKeypadViewManager, RCTViewManager)
...
RCT_EXPORT_VIEW_PROPERTY(securityMode, NSString)
RCT_EXPORT_VIEW_PROPERTY(acknowledgeLowerAssurance, NSNumber)
RCT_EXPORT_VIEW_PROPERTY(maxTokens, NSNumber)
RCT_EXPORT_VIEW_PROPERTY(timeoutMs, NSNumber)
RCT_EXPORT_VIEW_PROPERTY(cancelRequest, NSNumber)
RCT_EXPORT_VIEW_PROPERTY(headlessKeyPress, NSDictionary)
